...
=== Densité d'états (DOS)
 - *Graphique de la DOS* 
Le graphe de la densité d'états (DOS) montre l'évolution de la densité électronique en fonction de l'énergie. L'axe horizontal représente l'énergie (en eV), tandis que l'axe vertical représente la densité d'états. Le niveau de Fermi ($E_f$) est situé à :
